...
const AdvantageSolution = () => {
    ...
    return  (
            <>
                <div className={advantageStyle.title}>The FVL & TPL Advantage</div>
                <div className={advantageStyle.note}>At FVL & TPL, our mission is to do it better. How are we different?</div>
                {
                    contentList.map((contentItem, index) => {
                        return (
                            <div key={index}>
                                <div className={advantageStyle.subtitle}>{contentItem.subtitle}</div>
                                <div className={advantageStyle.subcontent}>{contentItem.subcontent}</div>
